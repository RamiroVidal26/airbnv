export const Servicios = ({ selected, onChange }) => {
  ...
  return (
    <>
      ...
      <div className="grid gap-2 items-center  grid-cols-2 md:grid-cols-4 lg:grid-cols-6 ">
        <label className="border p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
        ...
        <label className="border p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
            checked={selected.includes("lavarropa")}
            name="lavarropa"
            onChange={handleCbClick}
          />
          <span className="flex gap-1 items-center ">
        ...
        <label className="border p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
            checked={selected.includes("paisajes")}
            name="paisajes"
            onChange={handleCbClick}
          />
          <span className="flex gap-1 items-center ">
        ...
        <label className="border p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
            name="cocina"
            checked={selected.includes("cocina")}
            onChange={handleCbClick}
          />
          <span className="flex gap-1 items-center ">
            <svg
        ...
        <label className="border p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
            name="gimnasio"
            checked={selected.includes("gimnasio")}
            onChange={handleCbClick}
          />
          <span className="flex gap-1 items-center ">
            <svg
        ...
        <label className="border p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
            name="televisor"
            checked={selected.includes("televisor")}
            onChange={handleCbClick}
          />
          <span className="flex gap-1 items-center ">
            <svg
        ...
        <label className="border p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
            name="mascotas"
            checked={selected.includes("mascotas")}
            onChange={handleCbClick}
          />
          <span className="flex gap-1 items-center ">
            <svg
        ...
        <label className="border p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
            name="visitas"
            checked={selected.includes("visitas")}
            onChange={handleCbClick}
          />
          <span className="flex gap-1 items-center ">
            <svg
        ...
        <label className="border  p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
            checked={selected.includes("piscina")}
            name="piscina"
            onChange={handleCbClick}
          />
          <span className="flex gap-1 items-center ">
        ...
        <label className="border p-4 shadow-md  gap-2 flex cursor-pointer">
          <input
            type="checkbox"
            checked={selected.includes("nofumar")}
            name="nofumar"
            onChange={handleCbClick}
          />
          <span className="flex gap-1 items-center ">
